...
public class SwingRadioCheck_02 extends JFrame implements ActionListener {
	...
	Container cp;
	JRadioButton [] rb=new JRadioButton[4]; //하나만 선택하고 싶을떄
	JCheckBox[] cb=new JCheckBox[4];
	Color [] colors = {Color.RED,Color.GREEN,Color.MAGENTA,Color.PINK};
	JLabel lblMessage;
	...
	private void initDesign() 
	{
		...
		String [] str1= {"Red","Green","Magenta","Pink"};
		...
		//가운데 라벨
		lblMessage=new JLabel("안녕하세요 불금입니다",JLabel.CENTER);
		this.add("Center",lblMessage);
		lblMessage.setBorder(new LineBorder(Color.RED,2));

		//하단 패널에 보더로 감싼 4개의 체크박스 만들기
