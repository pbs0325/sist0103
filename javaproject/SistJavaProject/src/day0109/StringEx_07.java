...
public class StringEx_07 {
	...
	public static void main(String[] args) {
		...
		System.out.println("str3이 길이:"+str3.length());
		System.out.println("str4이 길이:"+str4.length());
		
		System.out.println("앞뒤 공백 제거후 str4의 길이:"+str4.trim().length());
		System.out.println("앞뒤 공백 제거후 str3의 길이:"+str3.trim().length());
		...
		System.out.println("str3에서 Nice부터 끝까지 추출:"+str3.substring(7, 15));
		
		//equals 는 같으면 true, 다르면 false
		...
		System.out.println("computer".compareTo("comauter"));
	}
