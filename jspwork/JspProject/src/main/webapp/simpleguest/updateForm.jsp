			...
			<table class="table table-bordered" style="width: 550px;">
				...
				<tr>
					...
					<td><input type="text" name="nickname" required="required"
						class="form-control" style="width: 120px;" value="<%=dto.getNickname()%>"></td>
				...
				<tr>
					...
					<tr>
					<td colspan="4">
						<textarea style="width: 530px; height: 100px;" name="content" class="form-control">
						<%=dto.getContent() %>
						</textarea>
					</td>
				</tr>
				<tr>
					...
					<input type="hidden" name="num" value="<%=num%>">
						...
						<input type="button" value="방명록" class="btn btn-outline-primary" onclick="location.href'guestList.jsp"  style="width:100px;">
					</td>
				</tr>
			</table>
		</form>
