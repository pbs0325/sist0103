...
function openId() {
	  window.open("idSearch.jsp", "jungbok", "left=100px, top=100px, width=800px, height=400px");
}
	$(function(){
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<div class="d-inline-flex">
					...
					<button  type="button" class="btn btn-danger btn-sm" style="margin-left:20px;" onclick="openId()">아이디 입력</button>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td >
					<input type="text" class="form-control"
					style="width: 200px;" name="m_hp" required="required">
				</td>
			</tr>
